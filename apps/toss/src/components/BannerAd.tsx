...
type BannerAdProps = Readonly<{
  /**
   * 배너 광고 배치 위치(광고 타입 아님 — 둘 다 '배너 광고'예요).
   * 어느 콘솔 광고 그룹 ID를 쓸지만 가를 뿐, SDK 렌더 방식은 같아요.
   * - `banner`(기본): 가로로 긴 표준 배너 — 본문/목록 사이에 자연스러워요.
   * - `feed`: 콘솔의 '배너(피드형)' 그룹 — 카드 목록 사이에 끼울 때 어울려요
   *   (전용 그룹 미설정 시 일반 배너 그룹으로 폴백).
   */
  format?: AdFormat;
