...
// 카운트다운 순수 헬퍼(getRemainingMs/formatCountdown)는 @picky/shared 로 단일화했어요.
// isDeadlineSoon 이 getRemainingMs 를 쓰므로 로컬 import 후 그대로 재수출해요.
import { formatCountdown, getRemainingMs } from '../shared';

export { formatCountdown, getRemainingMs };
