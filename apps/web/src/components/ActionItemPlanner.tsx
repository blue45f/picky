...
// 액션 플랜(담당자/기한/핸드오프/단계/마크다운/공지문) 생성은 @picky/shared(decisionMemo)로
// 단일화했어요. 이 컴포넌트는 폼 상태(담당자/기한)를 넣고 결과를 UI로만 렌더해요(동작 불변).
import { buildActionPlan } from '@picky/shared';
