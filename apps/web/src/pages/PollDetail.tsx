...
const RESULT_IMAGE_THEMES: Record<ResultImageTheme, ResultImageThemeConfig> = {
  classic: {
    bgStart: '#061411',
    bgMid: '#0d2a25',
    bgEnd: '#08100f',
...
function buildConsensusNarrative(
  ...
  let consensusLabel = '의견 분산';
  if (currentPoll.totalVotes === 0) {
    consensusLabel = '참여 대기';
  } else if (voteGap <= 1 && currentPoll.options.length > 1) {
    consensusLabel = '접전';
